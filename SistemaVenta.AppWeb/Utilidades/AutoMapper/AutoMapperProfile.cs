        ...
        public AutoMapperProfile()
        {
            ...
            CreateMap<VMProducto, Producto>()
               .ForMember(destino =>
                ...
                .ForMember(destino =>
                    destino.Precio,
                         opt => opt.MapFrom(origen => Convert.ToString(origen.Precio, new CultureInfo("es-NIC")))
                 );
            #endregion
            ...
            CreateMap<Venta, VMVenta>()
                 ...
                 .ForMember(destino =>
                   destino.SubTotal,
                    opt => opt.MapFrom(origen => Convert.ToString(origen.SubTotal.Value, new CultureInfo("es-NIC")))
                 )
                  .ForMember(destino =>
                   destino.ImpuestoTotal,
                    opt => opt.MapFrom(origen => Convert.ToString(origen.ImpuestoTotal.Value, new CultureInfo("es-NIC")))
                 )
                 .ForMember(destino =>
                   destino.Total,
            ...
            CreateMap<VMVenta, Venta>()
                 .ForMember(destino =>
                   destino.SubTotal,
                    opt => opt.MapFrom(origen => Convert.ToDecimal(origen.SubTotal, new CultureInfo("es-NIC")))
                 )
                  .ForMember(destino =>
                   destino.ImpuestoTotal,
                    opt => opt.MapFrom(origen => Convert.ToDecimal(origen.ImpuestoTotal, new CultureInfo("es-NIC")))
                 )
                 .ForMember(destino =>
                   destino.Total,
                    opt => opt.MapFrom(origen => Convert.ToDecimal(origen.Total, new CultureInfo("es-NIC")))
                 );
            #endregion
            ...
            CreateMap<DetalleVenta, VMReporteVenta>()
                ...
                .ForMember(destino =>
                    ...
                    opt => opt.MapFrom(origen => Convert.ToString(origen.IdVentaNavigation.SubTotal.Value, new CultureInfo("es-NIC")))
                )
                .ForMember(destino =>
                    destino.ImpuestoTotalVenta,
                    opt => opt.MapFrom(origen => Convert.ToString(origen.IdVentaNavigation.ImpuestoTotal.Value, new CultureInfo("es-NIC")))
                )
                .ForMember(destino =>
                    destino.TotalVenta,
