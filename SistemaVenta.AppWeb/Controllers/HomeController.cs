...
using SistemaVenta.AppWeb.Models;
...
namespace SistemaVenta.AppWeb.Controllers
{
    [Authorize]
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> ObtenerUsuario()
        {
            ...
            try
            {
                ...
                VMUsuarios usuario = _mapper.Map<VMUsuarios>(await _usuarioServicio.ObtenerPorID(int.Parse(idUsuario)));
        ...
        [HttpPost]
        public async Task<IActionResult> GuardarPerfil([FromBody]VMUsuarios modelo)
        {
            GenericResponse<VMUsuarios> response = new GenericResponse<VMUsuarios>();
            try
            {
                ...
                bool resultado = await _usuarioServicio.GuardarPeril(entidad);
