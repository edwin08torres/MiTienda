...
public partial class DbA985c6DbventaContext : DbContext
{
    public DbA985c6DbventaContext()
    {
    }

    public DbA985c6DbventaContext(DbContextOptions<DbA985c6DbventaContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240CDACF54A5");
        ...
        {
            entity.HasKey(e => e.IdCliente).HasName("PK__Cliente__D5946642772E6BED");
            ...
            entity.HasOne(d => d.IdTipoIdentificacionNavigation).WithMany(p => p.Clientes)
                ...
                .HasConstraintName("FK__Cliente__IdTipoI__282DF8C2");
        });
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F3C01FE87");
            ...
            entity.HasOne(d => d.IdVentaNavigation).WithMany(p => p.DetalleVenta)
                ...
                .HasConstraintName("FK__DetalleVe__idVen__22751F6C");
        });

        modelBuilder.Entity<Identificacion>(entity =>
        {
            entity.HasKey(e => e.IdTipoIdentificacion).HasName("PK__Identifi__F521C6A8A95F8397");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132F0894325");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6BDD1DDDA");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D56140F8C1882");
            ...
            entity.Property(e => e.IdTipoDocumentoVenta).HasColumnName("idTipoDocumentoVenta");
            entity.Property(e => e.IdUsuario).HasColumnName("idUsuario");
            entity.Property(e => e.ImporteCambio).HasColumnType("decimal(18, 2)");
            entity.Property(e => e.ImporteRecibido).HasColumnType("decimal(18, 2)");
            ...
            entity.HasOne(d => d.IdClienteNavigation).WithMany(p => p.Venta)
                ...
                .HasConstraintName("FK__Venta__IdCliente__236943A5");

            entity.HasOne(d => d.IdTipoDocumentoVentaNavigation).WithMany(p => p.Venta)
                .HasForeignKey(d => d.IdTipoDocumentoVenta)
                .HasConstraintName("FK__Venta__idTipoDoc__1DB06A4F");

            entity.HasOne(d => d.IdUsuarioNavigation).WithMany(p => p.Venta)
                .HasForeignKey(d => d.IdUsuario)
                .HasConstraintName("FK__Venta__idUsuario__1EA48E88");
        });
